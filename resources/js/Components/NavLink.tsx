...
export default function NavLink({ href, active, children }: Props) {
    return (
        <Link
            ...
            className={
                active
                    ? "text-white border-white inline-flex items-center px-1 pt-1 border-b-2 border-gray-1000 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-white transition duration-150 ease-in-out"
