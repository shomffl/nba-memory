...
export default function Authenticated({
    ...
    return (
        <div className="min-h-screen bg-white">
            <nav className="bg-gray-1000 border-b border-gray-1000 shadow">
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex bg-gray-1000 items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-white hover:text-gray-300 focus:outline-none transition ease-in-out duration-150"
                                            >
                                                {auth.user.name}
